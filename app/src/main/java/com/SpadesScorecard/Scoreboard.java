...
public class Scoreboard extends FragmentActivity implements OnFragmentInteractionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.playerOneScore = findViewById(R.id.playerOneScore);
        this.playerTwoScore = findViewById(R.id.playerTwoScore);
        this.playerThreeScore = findViewById(R.id.playerThreeScore);
        this.playerFourScore = findViewById(R.id.playerFourScore);
        playerOneBid = findViewById(R.id.playerOneBid);
        playerTwoBid = findViewById(R.id.playerTwoBid);
        playerThreeBid = findViewById(R.id.playerThreeBid);
        playerFourBid = findViewById(R.id.playerFourBid);
        playerOneTricks = findViewById(R.id.playerOneTricks);
        playerTwoTricks = findViewById(R.id.playerTwoTricks);
        playerThreeTricks = findViewById(R.id.playerThreeTricks);
        playerFourTricks = findViewById(R.id.playerFourTricks);
